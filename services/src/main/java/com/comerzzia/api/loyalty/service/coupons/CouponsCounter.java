...
@Component
public class CouponsCounter {

	protected static final String CONTADOR = "LY_COUPON_ID";
	
	@Autowired
	ContadoresService contadoresService;

	public Long getCounterValue(IDatosSesion datosSesion) throws ContadorException {
