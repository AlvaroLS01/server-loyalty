...
<html>
  ...
  <body onkeydown="keyDown();">
    <cmz:main>
      <cmz:panelCMZ>
        <cmz:cabeceraPanelCMZ titulo="Información" icono="comun/images/iconos/info.gif"></cmz:cabeceraPanelCMZ>
	          				...
	          				<cmz:panel>
				            	<cmz:cuerpoPanel alineacion="center">
				            		<table align="center" width="220px;">
				            			<tr>
				            				<td><img src='<c:url value="comun/images/iconos/info.png"/>'></td>
				            				<td>
				                                    	...
				                                    	<table cellpadding="4" cellspacing="2" border="0" width="100%">
															<c:choose>
																<c:when test="${requestScope.mensaje == null}">
																	<tr>
																		<td align="center" class="mensaje" style="font-size: 12px;"><cmz:etiqueta titulo="Informe vacío"/>.</td>
																	</tr>						
																</c:when>
																<c:otherwise>
																	<tr>
