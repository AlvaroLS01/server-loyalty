...
public class ClienteNotFoundException extends com.comerzzia.pos.util.exception.Exception{
    ...
    public String getMessageDefault() {
    	return I18N.getTexto("El cliente consultado no se encuentra registrado en el sistema");
    }
