...
public class CajasServiceException extends com.comerzzia.pos.util.exception.Exception{
    ...
    public String getMessageDefault() {
    	return I18N.getTexto("Error procesando movimientos de caja del sistema");
    }
