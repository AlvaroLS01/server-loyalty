...
import com.comerzzia.api.commons.security.jwt.ComerzziaAuthenticationToken;
import com.comerzzia.api.commons.security.jwt.TokenProvider;
import com.comerzzia.api.commons.usuarios.ComerzziaUserDetails;
...
public class OAuth2TokenMockUtil {    
    ...
    public OAuth2PostProcessor createAuthentication(String username, Set<String> scopes, Set<String> roles) {
        List<GrantedAuthority> authorities = roles.stream()
            .map(SimpleGrantedAuthority::new)
            .collect(Collectors.toList());
        
        //ComerzziaUserDetails principal = new ComerzziaUserDetails("administrador", "NON-FOOD", "cmzx", true, null, true, true, true, true, authorities);
        //ComerzziaAuthenticationToken auth = new ComerzziaAuthenticationToken(principal, "password", "NON-FOOD", null, true, authorities);

//        return new OAuth2PostProcessor(tokenProvider.createToken(auth, false));
        return null;
    }
...
//            .collect(Collectors.toList());
//        
//        ComerzziaUserDetails principal = new ComerzziaUserDetails("administrador", "NON-FOOD", "cmz", true, null, true, true, true, true, authorities);
//        ComerzziaAuthenticationToken auth = new ComerzziaAuthenticationToken(principal, "password", "NON-FOOD", null, true, authorities);
//
